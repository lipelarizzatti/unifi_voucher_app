...
$controllerurl      = 'https://192.168.10.7:8443'; // full url to the UniFi Controller, eg. 'https://22.22.11.11:8443', for UniFi OS-based
                          // controllers a port suffix isn't required, no trailing slashes should be added
$controllerversion  = '6.0.41'; // the version of the Controller software, e.g. '4.6.6' (must be at least 4.0.0)
